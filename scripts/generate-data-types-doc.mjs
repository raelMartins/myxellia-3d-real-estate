/**
 * Writes docs/DATA_TYPES.md — a plain-language overview of data shapes used in the app.
 * Run: npm run doc:data-types
 */
...
const outFile = join(outDir, 'DATA_TYPES.md');
...
const lines = [
    ...
    '---',
    '',
    `*Last generated: ${generatedAt} (UTC).*`,
    '',
];
